...
loss_path = '/home/user/ZHOU-Wen/PINN/two-phase-flow/LS/0-0.6/loss.csv'
...
data_bc = np.load('/home/user/ZHOU-Wen/PINN/two-phase-flow/LS/0-0.6/data_bc.npy')
...
# IC
data_ic = np.load('/home/user/ZHOU-Wen/PINN/two-phase-flow/LS/0-0.6/data_ic.npy')
...
# PDE
# data_pde = np.load('/home/user/ZHOU-Wen/PINN/two-phase-flow/LS/0-0.6/data_pde.npy')
# np.random.shuffle(data_pde)
data_pde = np.load('/home/user/ZHOU-Wen/PINN/two-phase-flow/LS/0-0.6/extended_data_pdes.npy')
# data_pde = np.load('/home/user/ZHOU-Wen/PINN/two-phase-flow/LS/0-0.6/extended_resample_data_pdes.npy')
...
for epoch in range(iterations):
    ...
    # torch.save(net, '/home/user/ZHOU-Wen/PINN/two-phase-flow/LS/0-0.6/last_net.pth')
    if loss < min_loss:
        min_loss = loss
        # 保存模型语句
        torch.save(net, '/home/user/ZHOU-Wen/PINN/two-phase-flow/LS/0-0.6/best_net_pde.pth')
        # torch.save(net, '/home/user/ZHOU-Wen/PINN/two-phase-flow/LS/0-0.6/best_net_resample_pde.pth')
