...
max_a = 1.0
min_a = -1.0
model_file_path = '/home/user/ZHOU-Wen/PINN/two-phase-flow/LS/0-0.6/best_net_pde.pth'
next_data_ic_file_path = '/home/user/ZHOU-Wen/PINN/two-phase-flow/LS/0-0.6/next_data_ic.npy'
...
indices = np.sort(np.concatenate([indices[3:31:temporal_step_size],], axis=0))
...
# net = torch.load('/home/user/ZHOU-Wen/PINN/two-phase-flow/LS/0-0.6/best_net_resample_pde.pth')
# net = torch.load('/home/user/ZHOU-Wen/PINN/two-phase-flow/LS/0-0.6/best_net(batchsize).pth')
